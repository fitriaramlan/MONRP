...
for run = 1 : Runs
    ...
    for Gene = 1 : Generations
        ...
        NewPopulation       = F_operator_bnc_bwm(Population(MatingPool',:),Boundary);
        for i = 1 : npop
    ...
    F_output(Population,toc,'NSGAII_NRPmul_BNC-BWM_g4',P_customer,S_customer,Req_percus,Cost_req,N,M,run);
end
