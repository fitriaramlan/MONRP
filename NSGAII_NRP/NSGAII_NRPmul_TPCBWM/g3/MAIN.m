...
for run = 1 : Runs
    ...
    for Gene = 1 : Generations
        ...
        NewPopulation       = F_operator_tpc_bwm(Population(MatingPool',:),Boundary);
        for i = 1 : npop
    ...
    F_output(Population,toc,'NSGAII_NRPmul_TPC-BWM_g3',P_customer,S_customer,Req_percus,Cost_req,N,M,run);
end
