...
for run = 1 : Runs
    ...
    for Gene = 1 : Generations
        ...
        NewPopulation       = F_operator_radius(Population(MatingPool',:),FunctionValue(MatingPool',:),FrontValue(MatingPool'),Boundary);
        for i = 1 : npop
    ...
    F_output(Population,toc,'NSGAII_NRPmul_SPC-radMut_g4_pt6',P_customer,S_customer,Req_percus,Cost_req,N,M,run);
end
