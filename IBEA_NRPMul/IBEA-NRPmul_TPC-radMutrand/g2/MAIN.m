...
for run = 1 : Runs
    ...
    for Gene = 1 : Generations
        ...
        Offspring                     = F_operator_radius_TPC(Population(MatingPool',:),FunctionValue(MatingPool',:),Boundary);
    ...
    F_output(Population,toc,'IBEA-NRPmul_TPC-radMutrand-g2',P_customer,S_customer,Req_percus,Cost_req,N,M,run);
