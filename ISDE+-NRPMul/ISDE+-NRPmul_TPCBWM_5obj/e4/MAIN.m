...
for run = 1: Runs
    ...
    for Gene = 1 : Generations
        ...
        Offspring             = F_operator_tpc_bwm(Population(MatingPool',:),Boundary);
    ...
    F_output(Population,toc,'ISDE+-NRPmul_TPC-BWM-e4',P_customer,S_customer,Req_percus,Cost_req,N,M,run);
end